...
//             className="border w-full p-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400"
//             required
//             disabled={loading}
//           />
//           <Mail
...
//           <button
//             type="submit"
//             className="bg-blue-500 text-white w-1/2 p-2 rounded-full hover:bg-blue-600 transition disabled:bg-gray-400"
//             disabled={loading}
//           >
